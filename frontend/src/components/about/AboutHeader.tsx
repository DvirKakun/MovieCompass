  ...
  return (
    ...
    >
      <motion.div
        ...
        className="inline-flex items-center gap-2 bg-brand-primary/10 border border-primary/20 rounded-full px-4 py-2 mb-6"
      >
      ...
      >
        ...
        guide through the vast universe of entertainment, helping you discover,
        explore, and enjoy films like never before.
      </motion.p>
    </motion.div>
  );
}
